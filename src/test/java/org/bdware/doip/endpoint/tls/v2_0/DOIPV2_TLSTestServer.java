...
public class DOIPV2_TLSTestServer {
    static Logger LOGGER = LogManager.getLogger(DOIPV2_TLSTestServer.class);
    ...
    public static void run(int port) throws InterruptedException {
        ...
        try {
            ...
            TLSListenerInfo tlsinfo = new TLSListenerInfo("tls://127.0.0.1:" + port, DOIPVersion.V2_0, chain, key);
            infos.add(tlsinfo);
        } catch (Exception e) {
            e.printStackTrace();
        }
