...
package org.bdware.doip.endpoint.udp;
...
public class UDPTestClient {
    static Logger LOGGER = LogManager.getLogger(UDPTestClient.class);

    @Test
    public void request() throws Exception {
        String address = "udp://127.0.0.1:21042/";
        ...
        DigitalObject digitalObject = DoExample.b2000;
